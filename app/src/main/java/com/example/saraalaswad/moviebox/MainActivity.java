...
import com.example.saraalaswad.moviebox.MovieDetails.MovieDetailActivity;
import com.example.saraalaswad.moviebox.MovieDetails.MovieDetailFragment;
import com.example.saraalaswad.moviebox.databaseSQLITE.MovieContract;
import com.example.saraalaswad.moviebox.utilities.NetworkUtils;
...
public class MainActivity extends AppCompatActivity implements MovieAdapter.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public class FetchMovies extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            popularMoviesURL = "https://api.themoviedb.org/3/movie/popular?api_key="+"655357f554a9983a18701b9d601538f6"+"&language=en-US";
            topRatedMoviesURL = "https://api.themoviedb.org/3/movie/top_rated?api_key="+"655357f554a9983a18701b9d601538f6"+"&language=en-US";
